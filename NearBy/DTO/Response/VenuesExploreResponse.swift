...
public class VenuesExploreResponse: CodableEquatable {
    ...
    public init(warning: Warning, suggestedRadius: Int, headerLocation: String, headerFullLocation: String, headerLocationGranularity: String, totalResults: Int, suggestedBounds: SuggestedBounds, groups: [Group]) {
